...
# _hybrid_replay (pinned seed for reproducibility), then reports per-window +
# mean + worst-window delta. This is the reliable scoreboard for evaluating
# pure-LLM / hybrid strategy changes — a single window is noise.
#
# Usage:  ./llm-walkforward.sh [extra args...]
# Examples:
#   ./llm-walkforward.sh                              # 4 windows × 30 days, pure-LLM, seed 42
...
#   ./llm-walkforward.sh --seed -1                    # disable seed pinning (non-deterministic)
